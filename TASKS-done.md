...
- [x] `H106` Citations round 2 — Florin Fortiș's review of Alexandra Fortiș's FV Info 2026 export
  (2026-09-12). **STATUS 2026-09-13: all code slices in prod (`206dbcdb`), S7 answered, replies sent.**
  Left before closing: (i) Alexandra re-runs a FULL citations sync → Energy Research citation heals to A/8;
  (ii) the AISC citation turns D after the 03:20 Crossref sweep — both are data, no code. Spin-offs for the
  backlog: user-asserted / BibTeX citation import (EMAC chapter, PLoP — not Scopus documents) and a review
  queue for unverified REFTITLE hits. Two families: the xlsx export of the citations block is broken in prod, and citation
  ...
  - S5 — **Coverage: Scopus reverse-title citation search.** Root cause of items 1–4: the Scopus
    ...
    **Decisions 2026-09-12 (Adrian), final:** the REFTITLE pass runs for ALL confirmed works, every sync,
    ...
    auto-ingest, provenance `SCOPUS_REFTITLE`, incremental by PUBYEAR. **BUILT 2026-09-12, VERIFIED IN PROD 2026-09-13** (Alexandra's FULL citations sync; see
...
## H97 Matematică — the 2026 fișă (archived 2026-09-13)

Archived from `TASKS.md`. S1 (`scieIndexed` gate) and S2 (`mate_2026_report.js`) done 2026-08-02; "FV Matematică 2026" verified present in prod 2026-09-13. S3 (tighten the 2016 C4 gate with `scieIndexed`) stays optional, only if the comisie asks — reopen on request.

- [x] `H97` Matematică — the 2026 fișă (COMISIA 1, OM 3.019/2025).
  **RAISED 2026-08-02.** The 2016 fișă is done and faithful (names/perspectives/descriptions, the
  ...
  - [x] **S2 — the fișă — DONE 2026-08-02** (`mate_2026_report.js`, local + seeds; in prod — verified 2026-09-13).
...
## H98 Fizică — the 2026 fișă (archived 2026-09-13)

Archived from `TASKS.md`. S1 core (`fizica_2026_report.js`), S2 A1/A2/A4/A5 on the archived Master Book List and S3 brevete A7/A8 done 2026-08-02/03; "FV Fizică 2026" verified present in prod 2026-09-13. Not covered, by data availability: A3 book editorship and A6 ISI proceedings ≥3 pages. Optional remainders (a 2016 UVT fișă, validation against a real filled fișă from doctorat.uvt.ro) reopen on a physics request.

- [x] `H98` Fizică — the fișă (COMISIA 3). **RAISED 2026-08-02.**
  ...
  - [x] **S1 — the 2026 fișă core — DONE 2026-08-02** (`fizica_2026_report.js`, local + seeds; in prod —
    verified 2026-09-13). "FV Fizică 2026": Fiz26_I (`S/Nef`), _P (`S`, FIRST_OR_CORRESPONDING), _C
...
## H68 Advanced criteria / threshold extensions (archived 2026-09-13)

Archived from `TASKS.md`. The consumed extensions (position-aware caps, `Poz`, `maxPercentOfTotal`, count+point mixes) shipped under their consuming reports. Everything else — post-PhD temporal anchor, best-of assignment, Da/Nu gates, cross-criterion compensation — is deferred to its first consumer because the semantics are ambiguous without a real report. Closed as a container; a new fișă that needs one reopens that item specifically.

- [x] `H68` Advanced criteria / threshold extensions (foundational, from the standards assessment).
  ...
  **SCOPED 2026-06-30** (`docs/tasks/closed/h68-criteria-extensions.md`).
  ...
  **Slice 3 DONE (2026-07-24, `4c86671b`): percent-of-criterion caps.** OM 3019/2025 Informatică D caps D(x)/D(xiv)
  ...
  `docs/tasks/closed/h68-criteria-extensions.md` (Slice 3).

...
- H06 baseline is complete for planning and execution:
  - architecture/data ownership map: `docs/h06-persistence-map.md`
  - schema drift inventory: `docs/h06-schema-drift-inventory.md`
  - query consistency findings: `docs/h06-query-consistency-findings.md`
  - canonical contracts: `docs/h06-persistence-contracts.md`
  - phased remediation plan: `docs/h06-remediation-plan.md`

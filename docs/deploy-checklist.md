...
| `DBLP_DUMP_FILE` | `/app/data/dblp-2026-09-01.xml.gz` | ConfigMap (env overrides the committed dev path — Spring gives env vars precedence over application.properties) |

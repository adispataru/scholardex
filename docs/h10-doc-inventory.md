...
Date: 2026-03-04  
Status: baseline inventory for `H10-S01`.
...
- `CONTRIBUTING.md`
- `TASKS.md`
- `docs/h02-dependency-rules.md`
- `docs/h04-reliability-guardrails.md`
- `docs/h06-remediation-plan.md`
- `docs/h07-remediation-plan.md`
- `docs/h08-remediation-plan.md`
- `docs/h09-ci-gates.md`
- `HELP.md`
- `FEATURES.md`
...
| Verification command selection | scattered (`CONTRIBUTING.md`, `docs/h04-*`, `docs/h09-ci-gates.md`) | missing centralized map | No single “change type -> required commands” matrix. | App Architecture Owner | `H10-S04` |
| CI/guardrail failure triage | `docs/h09-ci-gates.md` | partial | CI policy exists, but guardrail-specific failure diagnosis is missing. | Quality Owner | `H10-S05` |

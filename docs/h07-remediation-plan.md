...
- H07 baseline is complete for planning and implementation:
  - security surface/trust boundaries: `docs/h07-security-surface-map.md`
  - validation drift inventory: `docs/h07-validation-drift-inventory.md`
  - error-handling findings: `docs/h07-error-handling-findings.md`
  - canonical contracts: `docs/h07-security-validation-contracts.md`
  - phased remediation and enforcement: `docs/h07-remediation-plan.md`

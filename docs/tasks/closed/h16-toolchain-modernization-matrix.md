...
- Updated CI baseline documentation in `docs/tasks/closed/h09-ci-gates.md` to reflect Java 25 parity.
...
2. If CI shows environment-specific drift, capture in `docs/tasks/closed/h10-failure-triage.md` with a targeted remediation note.

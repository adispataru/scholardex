...
| Documentation governance or doc-tree changes | `npm run verify-docs-governance` | Protect active-doc indexing, status classification, and archive/reference boundaries. |
...
Final required checks on `main` (see `docs/tasks/closed/h09-ci-gates.md`):

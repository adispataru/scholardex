...
- `docs/tasks/closed/h08-observability-contracts.md`
- `docs/tasks/closed/h08-regression-guards.md`
...
- H12 now provides deterministic Scopus/import correctness contracts (retry/backoff + mapping validation + partial-import summaries); see `docs/tasks/closed/h12-integration-contracts.md`.

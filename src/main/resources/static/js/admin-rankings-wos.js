(function () {
  ...
  const els = {
    search: document.getElementById('admin-wos-search'),
    sort: document.getElementById('admin-wos-sort'),
    direction: document.getElementById('admin-wos-direction'),
    size: document.getElementById('admin-wos-size'),
    loading: document.getElementById('admin-wos-loading'),
    error: document.getElementById('admin-wos-error'),
    empty: document.getElementById('admin-wos-empty'),
    tableBody: document.getElementById('admin-wos-table-body'),
    pageInfo: document.getElementById('admin-wos-page-info'),
    totalInfo: document.getElementById('admin-wos-total-info'),
    prev: document.getElementById('admin-wos-prev'),
    next: document.getElementById('admin-wos-next')
  };
  ...
  function renderRows(items) {
    ...
    const html = items.map(function (item) {
      ...
      return '<tr>' +
        '<td><a href="/admin/rankings/wos/' + id + '">' + escapeHtml(item.name) + '</a></td>' +

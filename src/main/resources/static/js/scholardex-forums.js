(function () {
  ...
  const els = {
    search: document.getElementById('scholardex-forums-search'),
    sort: document.getElementById('scholardex-forums-sort'),
    direction: document.getElementById('scholardex-forums-direction'),
    wos: document.getElementById('scholardex-forums-wos'),
    size: document.getElementById('scholardex-forums-size'),
    loading: document.getElementById('scholardex-forums-loading'),
    error: document.getElementById('scholardex-forums-error'),
    empty: document.getElementById('scholardex-forums-empty'),
    tableBody: document.getElementById('scholardex-forums-table-body'),
    pageInfo: document.getElementById('scholardex-forums-page-info'),
    totalInfo: document.getElementById('scholardex-forums-total-info'),
    prev: document.getElementById('scholardex-forums-prev'),
    next: document.getElementById('scholardex-forums-next')
  };

...
//    @GetMapping("/publications/exportCNFIS")
//    @ResponseBody
//    public void createCNFISReport(Authentication authentication, HttpServletResponse response,
...
//                List<Author> byId = scopusAuthorRepository.findByIdIn(r.getScopusId());
//                List<ro.uvt.pokedex.core.model.scopus.Publication> publications = new ArrayList<>();
//                List<Publication> finalPublications = publications;
//                byId.forEach(a -> {
//                    finalPublications.addAll(scopusPublicationRepository.findAllByAuthorsContaining(a.getId()));
//                });
//
//
//
...
//
//
//                List<String> authorIds = new ArrayList<>(r.getScopusId());
//
...
//                List<Forum> forums = scopusVenueRepository.findBySourceIdIn(forumKeys);
...
//                // Load the template Excel file
//
//                try (FileInputStream resource = new FileInputStream("data/templates/AC2025_Anexa5-Fisa_articole_brevete-2025.xlsx");
...
//                        Row row;
//
//                        row = AdminGroupController.copyRow(workbook, sheet, sampleRowNum, rowNum);
//
//
//                        String year = publication.getCoverDate() != null ? publication.getCoverDate().split("-")[0] : "";
//                        String title = publication.getTitle() != null ? publication.getTitle() : "";
...
//    @ResponseBody
//    public void createCNFISReport2025(Authentication authentication, HttpServletResponse response,
//                                  @RequestParam(name = "start", defaultValue = "2021") String startYear,
//                                  @RequestParam(name = "end", defaultValue = "2024") String endYear) throws IOException {
//
//        if (authentication == null || !(authentication.getPrincipal() instanceof User currentUser)) {
...
//                    int sampleRowNum = 16;
//                    for (Publication publication : publications) {
//                        publication = woSExtractor.findPublicationWosId(publications.get(i));
...
//                                    if(publication.getAffiliations().contains(affiliation.getAfid()) &&
//                                            univAffil.contains(affiliation.getAfid())){
//                                        count++;
//                                    }
//                                }
//                            }
//                        }
//                        long universityAuthors = count;
//                        System.out.println("Row: " + rowNum + " - Title: " + title);
//                        row.getCell(1).setCellValue(year);
//                        row.getCell(2).setCellValue(title);
//                        row.getCell(3).setCellValue(doi);

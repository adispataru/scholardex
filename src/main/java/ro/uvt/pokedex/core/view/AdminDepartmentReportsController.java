 ...
 * current DepartmentAffiliation entries; scores are computed live. Persisted run history is
...
public class AdminDepartmentReportsController {
    ...
    public String viewReport(@PathVariable String departmentId,
                             ...
                             Model model) {
        Optional<OrgUnitReportViewModel> view = departmentReportFacade.buildView(departmentId, reportId);

...
//    @Query("{ 'authors': { $in: ?0 } }")
    List<Publication> findAllByAuthorsIn(Collection<String> author);
    ...
    List<Publication> findAllByAuthorsInAndTitleContains(Collection<String> authorIds, String paperTitle);

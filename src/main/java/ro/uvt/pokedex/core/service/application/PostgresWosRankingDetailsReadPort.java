...
public class PostgresWosRankingDetailsReadPort {
    ...
    public Optional<WoSRanking> findByJournalId(String journalId) {
        ...
        MapSqlParameterSource params = new MapSqlParameterSource("journalId", journalId);
        ...
        List<WosMetricFact> scoreFacts = namedParameterJdbcTemplate.query(
                """
        ...
        return Optional.of(toLegacyDetails(views.getFirst(), scoreFacts, categoryFacts));
    }

    private WosRankingView mapRankingView(java.sql.ResultSet rs, int ignored) throws SQLException {

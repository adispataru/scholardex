...
public class EntityForumApiController {

    private final PostgresScholardexForumReadPort postgresScholardexForumReadPort;

    @GetMapping("/forums")
    public ResponseEntity<ScholardexForumPageResponse> listForums(
        ...
        return ResponseEntity.ok(postgresScholardexForumReadPort.search(page, size, sort, direction, q));
    }
}

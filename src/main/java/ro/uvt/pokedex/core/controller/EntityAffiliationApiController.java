...
public class EntityAffiliationApiController {

    private final PostgresScholardexAffiliationReadPort postgresScholardexAffiliationReadPort;

    @GetMapping("/affiliations")
    public ResponseEntity<ScholardexAffiliationPageResponse> listAffiliations(
        ...
        return ResponseEntity.ok(postgresScholardexAffiliationReadPort.search(page, size, sort, direction, q));
    }
}

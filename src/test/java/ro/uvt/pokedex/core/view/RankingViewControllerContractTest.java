...
class RankingViewControllerContractTest {
    ...
    void rankingsHubRendersAllThreeTabsAndClientControls() throws Exception {
        mockMvc.perform(get("/rankings"))
                ...
                .andExpect(content().string(org.hamcrest.Matchers.containsString("<th scope=\"col\" data-sort-key=\"name\">Conference</th>")))
                ...
                .andExpect(content().string(org.hamcrest.Matchers.containsString("<th scope=\"col\" data-sort-key=\"name\">University</th>")))
    ...
    void authenticatedRankingsHubExposesWosTabAndClientControls() throws Exception {
        mockMvc.perform(get("/rankings").with(authenticatedUser(userWithRoles("u@uvt.ro", Set.of(UserRole.RESEARCHER)))))
                ...
                .andExpect(content().string(org.hamcrest.Matchers.containsString("<th scope=\"col\" data-sort-key=\"categoryName\">Category</th>")))

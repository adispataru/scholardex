...
class AdminConflictControllerContractTest {
    ...
    void conflictsPageRendersTemplateAndEndpoints() throws Exception {
        ...
        mockMvc.perform(get("/admin/conflicts"))
                ...
                .andExpect(content().string(org.hamcrest.Matchers.containsString("role=\"search\"")))
                .andExpect(content().string(org.hamcrest.Matchers.containsString("class=\"app-filter-panel\"")))

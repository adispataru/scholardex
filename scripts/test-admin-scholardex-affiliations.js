...
const scriptPath = path.join(__dirname, '..', 'src', 'main', 'resources', 'static', 'js', 'admin-scholardex-affiliations.js');
...
async function run() {
  ...
  console.log('admin-scholardex-affiliations.js behavior tests passed.');
}
